...
class SlideshowCard(models.Model):
    ...
    video_file = models.FileField(upload_to='slideshow/videos/', verbose_name="ملف فيديو (رفع مباشر)", blank=True, null=True, help_text="بديل عن رابط يوتيوب — mp4/webm — ارفع فقط إذا ما عندك رابط")
